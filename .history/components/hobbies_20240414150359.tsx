...
function Hobbies() {
  return (
    <section className="mb-28 max-w-[60rem] text-center leading-8 sm:mb-40 scroll-mt-28 bg-white border border-black/[0.1] rounded-xl px-5 py-3 dark:bg-white/10 dark:text-white/80">
